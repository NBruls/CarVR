...
public class OVRGrabber : MonoBehaviour
{
    ...
    public OVRGrabbable steeringWheel;   
    ...
    private GameObject _snapPositionLeft;
    private GameObject _snapPositionRight;
    ...
    {
        _snapPositionLeft = GameObject.FindGameObjectWithTag("SnapPositionLeft");
        _snapPositionRight = GameObject.FindGameObjectWithTag("SnapPositionRight");
    ...
    protected virtual void GrabBegin()
    {
        ...
        if (closestGrabbable != null)
        {
            ...
            if (m_grabbedObj.CompareTag("SteeringWheel")) {
                displayText.text = "DIKKE KUT";
    ...
    private void PlaceHandOnWheel(ref GameObject hand, ref Transform originalParent, ref bool handOnWheel) {
        ...
        if (_leftHandOnWheel) {
            ...
            hand.transform.parent = _snapPositionLeft.transform;
            hand.transform.position = _snapPositionLeft.transform.position;
        }
        if (_rightHandOnWheel) {
            originalParent = hand.transform.parent;
            hand.transform.parent = _snapPositionRight.transform;
            hand.transform.position = _snapPositionRight.transform.position;            
        }
    }
